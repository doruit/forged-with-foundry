...
|---|---|---|---|
| **[QLT-001 — Hallucination rate high](controls/grounding_and_quality/QLT-001_hallucination_rate_high/README.md)**<br>[Run the demo](controls/grounding_and_quality/QLT-001_hallucination_rate_high/README.md#demo) · [Scope](controls/grounding_and_quality/QLT-001_hallucination_rate_high/README.md#demo-scope) · [Assessment](controls/grounding_and_quality/QLT-001_hallucination_rate_high/ASSESSMENT.md) | Use Microsoft Foundry Continuous Evaluation groundedness failures as a hallucination-risk proxy, then apply a deterministic fleet policy that fails closed on incomplete scoring and routes review to the accountable role. Groundedness does not prove factual correctness. | Hybrid · Advanced · 60–90 min + up to 24 h async evaluation · Azure required; Teams optional | 2026-09-25 |
