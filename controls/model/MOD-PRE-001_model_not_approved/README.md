...
# MOD-PRE-001 — Model not approved
...
This control detects **model not approved** during the **Pre-Live** lifecycle
...
| **Control / signal** | Model not approved |
| **Evidence / source** | Approved model catalogue |
| **Trigger / threshold** | Model/vendor outside approved catalogue |
| **Action / gate effect** | Replace or submit exception |
...
flowchart LR
    ...
    D --> P{MOD-PRE-001 policy decision}
...
| Threshold reached | Control applies **Replace or submit exception** and routes accountability to **AI Engineering Lead**. |
