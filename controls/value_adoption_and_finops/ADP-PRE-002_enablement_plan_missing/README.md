...
# ADP-PRE-002 — Enablement plan missing
...
This control detects **enablement plan missing** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Block release or limit pilot** and routes accountability to **Change Lead**. |
...
| **Control / signal** | Enablement plan missing |
| **Evidence / source** | Training plan, comms plan |
| **Trigger / threshold** | No enablement before go-live |
| **Action / gate effect** | Block release or limit pilot |
...
flowchart LR
    ...
    D --> P{ADP-PRE-002 policy decision}
