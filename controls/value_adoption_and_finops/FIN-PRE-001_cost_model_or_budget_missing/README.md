...
# FIN-PRE-001 — Cost model or budget missing
...
This control detects **cost model or budget missing** during the **Pre-Live** lifecycle
...
| **Control / signal** | Cost model or budget missing |
| **Evidence / source** | Cost forecast, budget owner |
| **Trigger / threshold** | No budget, unit economics or limit |
| **Action / gate effect** | Block scale/go-live decision |
...
flowchart LR
    ...
    D --> P{FIN-PRE-001 policy decision}
...
| Threshold reached | Control applies **Block scale/go-live decision** and routes accountability to **FinOps Lead**. |
