...
This control detects **low repeat usage** during the **Live** lifecycle
...
| **Control / signal** | Low repeat usage |
| **Evidence / source** | Repeat users / first-time users |
| **Trigger / threshold** | <30% repeat after 30 days |
| **Action / gate effect** | Adoption diagnosis |
...
| Threshold reached | Control applies **Adoption diagnosis** and routes accountability to **Change Lead**. |
