...
This control detects **adoption decline** during the **Live** lifecycle
...
| Threshold reached | Control applies **Review journey/training** and routes accountability to **Change Lead**. |
...
| **Control / signal** | Adoption decline |
| **Evidence / source** | 30-day active users |
| **Trigger / threshold** | >20% decline |
| **Action / gate effect** | Review journey/training |
