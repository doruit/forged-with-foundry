...
SPEC = importlib.util.spec_from_file_location("val002_cleanup", Path(__file__).resolve().parents[1] / "infra/cleanup.py")
...
def resources():
    ...
    tags = {"control-id": "VAL-002", "purpose": "synthetic-benefits-realisation-demo"}
    workspace = {"id": prefix + "Microsoft.OperationalInsights/workspaces/log-val002-test",
                 "name": "log-val002-test", "type": "Microsoft.OperationalInsights/workspaces", "tags": tags.copy()}
    insights = {"id": prefix + "Microsoft.Insights/components/appi-val002-test",
                "name": "appi-val002-test", "type": "Microsoft.Insights/components", "tags": tags.copy(),
