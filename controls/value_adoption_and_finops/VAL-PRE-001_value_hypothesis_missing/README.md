...
This control detects **value hypothesis missing** during the **Pre-Live** lifecycle
...
| **Evidence / source** | Business case, benefits log |
...
flowchart LR
    ...
    D --> P{VAL-PRE-001 policy decision}
...
| Threshold reached | Control applies **Block approval to proceed** and routes accountability to **Business Owner**. |
