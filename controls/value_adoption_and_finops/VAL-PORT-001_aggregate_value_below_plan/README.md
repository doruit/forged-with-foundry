...
# VAL-PORT-001 — Aggregate value below plan
...
This control detects **aggregate value below plan** during the **Portfolio** lifecycle
...
| **Control / signal** | Aggregate value below plan |
| **Evidence / source** | Portfolio realised vs planned value |
| **Trigger / threshold** | <70% planned value realised |
| **Action / gate effect** | Reprioritise investments |
...
flowchart LR
    ...
    D --> P{VAL-PORT-001 policy decision}
...
| Threshold reached | Control applies **Reprioritise investments** and routes accountability to **Value Steering**. |
