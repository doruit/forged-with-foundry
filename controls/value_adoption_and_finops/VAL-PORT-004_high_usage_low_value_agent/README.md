...
# VAL-PORT-004 — High usage, low value agent
...
This control detects **high usage, low value agent** during the **Portfolio** lifecycle
...
| **Control / signal** | High usage, low value agent |
| **Evidence / source** | Usage vs KPI impact |
| **Trigger / threshold** | High active use with weak/no outcome |
| **Action / gate effect** | Redesign or retirement review |
...
flowchart LR
    ...
    D --> P{VAL-PORT-004 policy decision}
...
| Threshold reached | Control applies **Redesign or retirement review** and routes accountability to **Business Owner**. |
