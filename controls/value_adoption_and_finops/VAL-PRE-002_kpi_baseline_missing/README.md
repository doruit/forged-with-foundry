...
This control detects **kpi baseline missing** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Create baseline before approval** and routes accountability to **Business Owner**. |
...
| **Evidence / source** | Baseline KPI report |
| **Trigger / threshold** | No baseline or target before build |
...
flowchart LR
    ...
    D --> P{VAL-PRE-002 policy decision}
