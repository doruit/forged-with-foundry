...
# FIN-PORT-002 — Unit cost variance by team/domain
...
This control detects **unit cost variance by team/domain** during the **Portfolio** lifecycle
...
| Threshold reached | Control applies **Benchmark/optimize** and routes accountability to **FinOps Lead**. |
...
| **Control / signal** | Unit cost variance by team/domain |
| **Evidence / source** | Cost per outcome by team |
| **Trigger / threshold** | >30% unexplained variance |
| **Action / gate effect** | Benchmark/optimize |
...
flowchart LR
    ...
    D --> P{FIN-PORT-002 policy decision}
