...
# VAL-PRE-004 — Value owner not assigned
...
This control detects **value owner not assigned** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Assign benefit owner** and routes accountability to **Executive Sponsor**. |
...
| **Control / signal** | Value owner not assigned |
| **Evidence / source** | RACI, governance register |
| **Trigger / threshold** | No named owner for benefits |
| **Action / gate effect** | Assign benefit owner |
...
flowchart LR
    ...
    D --> P{VAL-PRE-004 policy decision}
