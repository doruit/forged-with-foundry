...
This control detects **kpi underperformance** during the **Live** lifecycle
...
| Threshold reached | Control applies **Value review** and routes accountability to **Business Owner**. |
