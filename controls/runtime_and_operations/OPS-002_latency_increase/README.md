...
This control detects **latency increase** during the **Live** lifecycle
...
| Threshold reached | Control applies **Performance tuning** and routes accountability to **Platform Owner**. |
...
| **Control / signal** | Latency increase |
| **Evidence / source** | p95 response time |
| **Trigger / threshold** | >5 sec or agreed SLO breach |
| **Action / gate effect** | Performance tuning |
