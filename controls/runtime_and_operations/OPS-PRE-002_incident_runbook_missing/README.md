...
# OPS-PRE-002 — Incident runbook missing
...
This control detects **incident runbook missing** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Block go-live** and routes accountability to **Ops Manager**. |
...
| **Control / signal** | Incident runbook missing |
| **Evidence / source** | Runbook, escalation matrix |
| **Trigger / threshold** | No incident workflow before launch |
...
flowchart LR
    ...
    D --> P{OPS-PRE-002 policy decision}
