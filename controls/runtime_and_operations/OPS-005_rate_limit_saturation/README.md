...
This control detects **rate-limit saturation** during the **Live** lifecycle
...
| Threshold reached | Control applies **Capacity action** and routes accountability to **Platform Owner**. |
...
| **Control / signal** | Rate-limit saturation |
| **Evidence / source** | Quota/rate-limit telemetry |
| **Trigger / threshold** | >80% sustained or hard throttle |
| **Action / gate effect** | Capacity action |
