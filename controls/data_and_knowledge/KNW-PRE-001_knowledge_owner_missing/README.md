...
# KNW-PRE-001 — Knowledge owner missing
...
This control detects **knowledge owner missing** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Assign owner** and routes accountability to **Knowledge Owner**. |
...
| **Control / signal** | Knowledge owner missing |
| **Evidence / source** | Knowledge source register |
| **Trigger / threshold** | No owner for governed source |
| **Action / gate effect** | Assign owner |
...
flowchart LR
    ...
    D --> P{KNW-PRE-001 policy decision}
