...
This control detects **unanswered rate high** during the **Live** lifecycle
...
| Threshold reached | Control applies **Knowledge gap review** and routes accountability to **Knowledge Owner**. |
...
| **Control / signal** | Unanswered rate high |
| **Evidence / source** | No-answer / fallback rate |
| **Trigger / threshold** | >10% |
| **Action / gate effect** | Knowledge gap review |
