...
# RSK-PRE-003 — Residual risk acceptance missing
...
This control detects **residual risk acceptance missing** during the **Pre-Live** lifecycle
...
| **Control / signal** | Residual risk acceptance missing |
| **Evidence / source** | Risk acceptance record |
| **Trigger / threshold** | Residual risk above tolerance |
| **Action / gate effect** | Block release or require acceptance |
...
flowchart LR
    ...
    D --> P{RSK-PRE-003 policy decision}
...
| Threshold reached | Control applies **Block release or require acceptance** and routes accountability to **Executive Sponsor**. |
