...
This control detects **hitl bypass** during the **Live** lifecycle
...
| Threshold reached | Control applies **Pause autonomy; incident review** and routes accountability to **Ops Manager**. |
...
| **Control / signal** | HITL bypass |
| **Evidence / source** | Action log vs approval matrix |
| **Trigger / threshold** | 1 occurrence |
| **Action / gate effect** | Pause autonomy; incident review |
