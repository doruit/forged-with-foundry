...
This control detects **irreversible action attempted** during the **Live** lifecycle
...
| Threshold reached | Control applies **Block action; escalate** and routes accountability to **Ops Manager**. |
...
| **Evidence / source** | Delete/submit/approve/publish/pay action log |
| **Trigger / threshold** | 1 unauthorized attempt |
| **Action / gate effect** | Block action; escalate |
