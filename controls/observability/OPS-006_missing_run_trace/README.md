...
This control detects **missing run trace** during the **Live** lifecycle
...
| **Control / signal** | Missing run trace |
| **Evidence / source** | Trace completeness |
| **Trigger / threshold** | <100% for critical runs |
| **Action / gate effect** | Fix telemetry |
...
| Threshold reached | Control applies **Fix telemetry** and routes accountability to **Ops Lead**. |
