...
This control detects **data classification missing** during the **Pre-Live** lifecycle
...
flowchart LR
    ...
    D --> P{DAT-PRE-002 policy decision}
...
| Threshold reached | Control applies **Classify before use** and routes accountability to **Data Owner**. |
