...
This control detects **hallucination rate high** during the **Live** lifecycle
...
| Threshold reached | Control applies **Quality review** and routes accountability to **Product Owner**. |
...
| **Evidence / source** | Validated hallucinations |
| **Trigger / threshold** | >5% or critical hallucination |
