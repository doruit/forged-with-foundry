...
This control detects **answer accuracy low** during the **Live** lifecycle
...
| Threshold reached | Control applies **Improve grounding/model** and routes accountability to **Product Owner**. |
...
| **Control / signal** | Answer accuracy low |
| **Evidence / source** | Accuracy score |
| **Trigger / threshold** | <85% on validation set |
| **Action / gate effect** | Improve grounding/model |
