...
This control detects **cost spike** during the **Live** lifecycle
...
| **Control / signal** | Cost spike |
| **Evidence / source** | Monthly cost trend |
| **Trigger / threshold** | >30% above rolling average |
| **Action / gate effect** | FinOps review |
...
| Threshold reached | Control applies **FinOps review** and routes accountability to **FinOps Lead**. |
