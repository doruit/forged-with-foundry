...
# OPS-003 — Technical failure rate high
...
This control detects **technical failure rate high** during the **Live** lifecycle
...
| **Control / signal** | Technical failure rate high |
| **Evidence / source** | Failure rate |
| **Trigger / threshold** | >2% |
| **Action / gate effect** | Incident review |
...
| Threshold reached | Control applies **Incident review** and routes accountability to **AI Ops Lead**. |
