...
# TOOL-PRE-002 — Tool risk tier not approved
...
This control detects **tool risk tier not approved** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Block tool access** and routes accountability to **Security Officer**. |
...
| **Control / signal** | Tool risk tier not approved |
| **Evidence / source** | Tool risk assessment |
| **Trigger / threshold** | High-impact tool without approval |
| **Action / gate effect** | Block tool access |
...
flowchart LR
    ...
    D --> P{TOOL-PRE-002 policy decision}
