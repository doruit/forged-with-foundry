...
This control detects **excessive tool calls** during the **Live** lifecycle
...
| **Control / signal** | Excessive tool calls |
| **Evidence / source** | Tool calls per task |
| **Trigger / threshold** | >approved call budget |
| **Action / gate effect** | Optimize workflow |
...
| Threshold reached | Control applies **Optimize workflow** and routes accountability to **AI Ops Lead**. |
