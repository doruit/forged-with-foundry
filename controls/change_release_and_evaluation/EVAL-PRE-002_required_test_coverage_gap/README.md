...
# EVAL-PRE-002 — Required test coverage gap
...
This control detects **required test coverage gap** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Extend test suite** and routes accountability to **QA Lead**. |
...
| **Control / signal** | Required test coverage gap |
| **Evidence / source** | Test plan, scenario coverage |
| **Trigger / threshold** | Critical scenarios not covered |
| **Action / gate effect** | Extend test suite |
...
flowchart LR
    ...
    D --> P{EVAL-PRE-002 policy decision}
