...
# REL-PRE-002 — Go-live approval missing
...
This control detects **go-live approval missing** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Do not release** and routes accountability to **Business Owner**. |
...
| **Control / signal** | Go-live approval missing |
| **Evidence / source** | Go/No-Go decision log |
| **Trigger / threshold** | No approved release decision |
| **Action / gate effect** | Do not release |
...
flowchart LR
    ...
    D --> P{REL-PRE-002 policy decision}
