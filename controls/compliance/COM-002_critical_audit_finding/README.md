...
# COM-002 — Critical audit finding
...
This control detects **critical audit finding** during the **Live** lifecycle
...
| **Control / signal** | Critical audit finding |
| **Evidence / source** | Open audit findings |
| **Trigger / threshold** | >0 critical |
| **Action / gate effect** | Action plan |
...
| Threshold reached | Control applies **Action plan** and routes accountability to **Compliance Officer**. |
