...
This control detects **benefits realisation gap** during the **Live** lifecycle
...
| **Trigger / threshold** | <50% realised after 6 months |
...
| Threshold reached | Control applies **Reassess hypothesis** and routes accountability to **Business Owner**. |
