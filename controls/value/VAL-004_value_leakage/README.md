...
This control detects **value leakage** during the **Live** lifecycle
...
| **Control / signal** | Value leakage |
| **Evidence / source** | Planned vs captured benefit |
| **Trigger / threshold** | >30% gap |
| **Action / gate effect** | Root-cause review |
...
| Threshold reached | Control applies **Root-cause review** and routes accountability to **Business Owner**. |
