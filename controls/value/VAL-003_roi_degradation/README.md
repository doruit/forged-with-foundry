...
This control detects **roi degradation** during the **Live** lifecycle
...
| **Control / signal** | ROI degradation |
| **Evidence / source** | Expected vs actual ROI |
| **Trigger / threshold** | >25% negative deviation |
...
| Threshold reached | Control applies **Portfolio review** and routes accountability to **Executive Sponsor**. |
