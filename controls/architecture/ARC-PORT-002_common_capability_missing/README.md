...
# ARC-PORT-002 — Common capability missing
...
This control detects **common capability missing** during the **Portfolio** lifecycle
...
| **Control / signal** | Common capability missing |
| **Evidence / source** | Capability heatmap |
| **Trigger / threshold** | Repeated bespoke implementations |
| **Action / gate effect** | Create reusable platform capability |
...
flowchart LR
    ...
    D --> P{ARC-PORT-002 policy decision}
...
| Threshold reached | Control applies **Create reusable platform capability** and routes accountability to **Architecture Board**. |
