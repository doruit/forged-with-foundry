...
# ARC-PORT-001 — Architecture drift
...
This control detects **architecture drift** during the **Portfolio** lifecycle
...
| **Control / signal** | Architecture drift |
| **Evidence / source** | Architecture conformance checks |
| **Trigger / threshold** | Unapproved pattern deviation |
...
flowchart LR
    ...
    D --> P{ARC-PORT-001 policy decision}
...
| Threshold reached | Control applies **Architecture review** and routes accountability to **Chief Architect**. |
