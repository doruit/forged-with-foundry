...
This control detects **negative satisfaction** during the **Live** lifecycle
...
| **Control / signal** | Negative satisfaction |
| **Evidence / source** | User satisfaction score |
| **Trigger / threshold** | <3.5/5 |
| **Action / gate effect** | UX/service review |
...
| Threshold reached | Control applies **UX/service review** and routes accountability to **Product Owner**. |
