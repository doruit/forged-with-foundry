...
This control detects **adoption rate low** during the **Live** lifecycle
...
| **Control / signal** | Adoption rate low |
| **Evidence / source** | Active users / target users |
| **Trigger / threshold** | <40% adoption |
| **Action / gate effect** | Adoption intervention |
...
| Threshold reached | Control applies **Adoption intervention** and routes accountability to **Change Lead**. |
