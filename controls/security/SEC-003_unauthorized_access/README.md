...
This control detects **unauthorized access** during the **Live** lifecycle
...
| Threshold reached | Control applies **Block and investigate** and routes accountability to **Security Officer**. |
...
| **Control / signal** | Unauthorized access |
| **Evidence / source** | Access violation |
| **Trigger / threshold** | 1 occurrence |
| **Action / gate effect** | Block and investigate |
