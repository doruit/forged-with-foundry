...
This control detects **secret exposure** during the **Live** lifecycle
...
| Threshold reached | Control applies **Rotate secret; incident response** and routes accountability to **Security Officer**. |
...
| **Control / signal** | Secret exposure |
| **Evidence / source** | Secret scanning in prompt/response/logs |
| **Trigger / threshold** | 1 occurrence |
| **Action / gate effect** | Rotate secret; incident response |
