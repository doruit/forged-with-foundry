...
# SEC-PRE-002 — Least-privilege model not approved
...
This control detects **least-privilege model not approved** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Reduce or approve access** and routes accountability to **Security Officer**. |
...
| **Control / signal** | Least-privilege model not approved |
| **Evidence / source** | RBAC, PIM, access review |
| **Trigger / threshold** | Excessive/unapproved permissions |
| **Action / gate effect** | Reduce or approve access |
...
flowchart LR
    ...
    D --> P{SEC-PRE-002 policy decision}
