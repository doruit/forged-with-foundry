...
This control detects **escalation spike** during the **Live** lifecycle
...
| **Control / signal** | Escalation spike |
| **Evidence / source** | Escalation rate |
| **Trigger / threshold** | >15% or >baseline +20% |
| **Action / gate effect** | Workflow review |
...
| Threshold reached | Control applies **Workflow review** and routes accountability to **AI Ops Lead**. |
