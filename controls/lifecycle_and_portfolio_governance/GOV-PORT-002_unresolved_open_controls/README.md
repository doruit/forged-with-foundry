...
# GOV-PORT-002 — Unresolved open controls
...
This control detects **unresolved open controls** during the **Portfolio** lifecycle
...
| Threshold reached | Control applies **Escalate to board** and routes accountability to **Compliance Officer**. |
...
| **Control / signal** | Unresolved open controls |
| **Evidence / source** | Control register |
| **Trigger / threshold** | Critical controls overdue |
| **Action / gate effect** | Escalate to board |
...
flowchart LR
    ...
    D --> P{GOV-PORT-002 policy decision}
