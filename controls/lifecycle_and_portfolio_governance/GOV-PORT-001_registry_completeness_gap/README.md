...
# GOV-PORT-001 — Registry completeness gap
...
This control detects **registry completeness gap** during the **Portfolio** lifecycle
...
| Threshold reached | Control applies **Clean-up campaign** and routes accountability to **Transformation Office**. |
...
| **Control / signal** | Registry completeness gap |
| **Evidence / source** | AI registry completeness score |
| **Trigger / threshold** | <100% critical fields for live agents |
| **Action / gate effect** | Clean-up campaign |
...
flowchart LR
    ...
    D --> P{GOV-PORT-001 policy decision}
