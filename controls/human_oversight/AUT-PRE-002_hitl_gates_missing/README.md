...
This control detects **hitl gates missing** during the **Pre-Live** lifecycle
...
| **Evidence / source** | Approval workflow design |
| **Trigger / threshold** | Material action has no human gate |
...
flowchart LR
    ...
    D --> P{AUT-PRE-002 policy decision}
...
| Threshold reached | Control applies **Block release** and routes accountability to **Business Owner**. |
