...
# LEG-PRE-001 — Legal review missing
...
This control detects **legal review missing** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Block release** and routes accountability to **Legal Counsel**. |
...
| **Control / signal** | Legal review missing |
| **Evidence / source** | Legal approval record |
| **Trigger / threshold** | Required review absent |
...
flowchart LR
    ...
    D --> P{LEG-PRE-001 policy decision}
