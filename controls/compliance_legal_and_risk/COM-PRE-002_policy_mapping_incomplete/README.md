...
# COM-PRE-002 — Policy mapping incomplete
...
This control detects **policy mapping incomplete** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Complete policy mapping** and routes accountability to **Compliance Officer**. |
...
| **Control / signal** | Policy mapping incomplete |
| **Evidence / source** | Control register |
| **Trigger / threshold** | Required policies not mapped |
| **Action / gate effect** | Complete policy mapping |
...
flowchart LR
    ...
    D --> P{COM-PRE-002 policy decision}
