...
# LEG-PRE-002 — IP/copyright risk unresolved
...
This control detects **ip/copyright risk unresolved** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Legal decision or mitigation** and routes accountability to **Legal Counsel**. |
...
| **Category / domain** | Legal-IP |
| **Control / signal** | IP/copyright risk unresolved |
| **Evidence / source** | Source/content license review |
| **Trigger / threshold** | Unresolved content, output or licensing risk |
| **Action / gate effect** | Legal decision or mitigation |
| **Accountable role** | Legal Counsel |
