...
This control detects **policy violation** during the **Live** lifecycle
...
| **Control / signal** | Policy violation |
| **Evidence / source** | Policy engine result |
| **Trigger / threshold** | 1 policy breach |
...
| Threshold reached | Control applies **Investigate** and routes accountability to **Compliance Officer**. |
