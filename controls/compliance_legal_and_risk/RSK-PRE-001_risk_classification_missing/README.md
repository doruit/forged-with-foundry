...
# RSK-PRE-001 — Risk classification missing
...
This control detects **risk classification missing** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Block approval to proceed** and routes accountability to **Risk Officer**. |
...
| **Control / signal** | Risk classification missing |
| **Evidence / source** | Risk questionnaire |
| **Trigger / threshold** | No risk tier assigned |
...
flowchart LR
    ...
    D --> P{RSK-PRE-001 policy decision}
