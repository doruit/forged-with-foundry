...
# RAI-PRE-001 — RAI impact assessment missing
...
This control detects **rai impact assessment missing** during the **Pre-Live** lifecycle
...
| Threshold reached | Control applies **Block release readiness** and routes accountability to **RAI Lead**. |
...
| **Category / domain** | Responsible AI |
| **Control / signal** | RAI impact assessment missing |
| **Evidence / source** | Responsible AI checklist |
| **Trigger / threshold** | Required assessment absent |
...
flowchart LR
    ...
    D --> P{RAI-PRE-001 policy decision}
