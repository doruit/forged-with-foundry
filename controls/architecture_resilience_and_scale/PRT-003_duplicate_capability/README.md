...
This control detects **duplicate capability** during the **Portfolio** lifecycle
...
| Threshold reached | Control applies **Rationalisation review** and routes accountability to **Architecture Board**. |
...
| **Control / signal** | Duplicate capability |
| **Evidence / source** | Agent capabilities map |
| **Trigger / threshold** | >3 agents solving same problem |
| **Action / gate effect** | Rationalisation review |
