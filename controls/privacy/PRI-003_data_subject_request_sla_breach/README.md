...
This control detects **data subject request sla breach** during the **Live** lifecycle
...
| Threshold reached | Control applies **Escalate** and routes accountability to **DPO**. |
