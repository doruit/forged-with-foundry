...
- **Proceed / revise / reject:** Proceed as a small teaching demo; retain the
...
must not be presented as the recommended production approval service. If Blob
...
- **Production extensions:** AGT action-bound approval, ACS tool mediation,
