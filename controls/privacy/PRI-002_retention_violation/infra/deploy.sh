#!/usr/bin/env bash
# Deploy only the additional Azure resources owned by PRI-002.
set -euo pipefail
...
DEPLOYMENT_NAME="pri-002-retention-violation"
...
require PRI002_STORAGE_ACCOUNT_NAME
...
update_env PRI002_STORAGE_BLOB_ENDPOINT "$(output_value storageBlobEndpoint)"
update_env PRI002_CONTAINER "$(output_value containerName)"

echo "✅ PRI-002 resources deployed incrementally; updated ${CONTROL_ENV}."
