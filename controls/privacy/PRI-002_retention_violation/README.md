...
This control detects **retention violation** during the **Live** lifecycle
...
| Threshold reached | Control applies **Remediate/delete** and routes accountability to **Privacy Officer**. |
