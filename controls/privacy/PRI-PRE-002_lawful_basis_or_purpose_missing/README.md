...
This control detects **lawful basis or purpose missing** during the **Pre-Live** lifecycle
...
| **Evidence / source** | Privacy assessment |
...
flowchart LR
    ...
    D --> P{PRI-PRE-002 policy decision}
...
| Threshold reached | Control applies **Remediate design** and routes accountability to **Privacy Officer**. |
