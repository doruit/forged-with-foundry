...
This control detects **retention design missing** during the **Pre-Live** lifecycle
...
| **Control / signal** | Retention design missing |
| **Evidence / source** | Retention schedule, logging design |
| **Trigger / threshold** | No retention rule for prompts/logs/data |
| **Action / gate effect** | Define retention before release |
...
flowchart LR
    ...
    D --> P{PRI-PRE-003 policy decision}
...
| Threshold reached | Control applies **Define retention before release** and routes accountability to **Privacy Officer**. |
