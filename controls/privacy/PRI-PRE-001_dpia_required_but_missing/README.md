...
This control detects **dpia required but missing** during the **Pre-Live** lifecycle
...
flowchart LR
    ...
    D --> P{PRI-PRE-001 policy decision}
...
| Threshold reached | Control applies **Block go-live** and routes accountability to **DPO**. |
